...
_CHAT_MODELS: list[ModelSpec] = [
    ...
    ModelSpec(
        ...
        display_name="Grok 2",
        capability="chat",
        description="xAI's flagship Grok 2 model — ultra-powerful reasoning, writing, and coding.",
    ...
    ModelSpec(
        ...
        capability="chat",
        description="Grok 2 flagship with state-of-the-art multi-modal vision capabilities.",
        context_window=131072,
        max_output_tokens=4096,
        input_price_per_1k=0.002,
        output_price_per_1k=0.01,
    ...
    ModelSpec(
        ...
        provider="openrouter",
        model="x-ai/grok-2",
        display_name="Grok 2 (OpenRouter)",
        capability="chat",
        description="xAI Grok 2 via OpenRouter — ultra-powerful, no direct xAI key needed.",
        context_window=131072,
        max_output_tokens=4096,
        input_price_per_1k=0.002,
        output_price_per_1k=0.01,
    ...
    ModelSpec(
        id="openrouter:grok-2-vision",
        provider="openrouter",
        model="x-ai/grok-2-vision",
        display_name="Grok 2 Vision (OpenRouter)",
        capability="chat",
        description="xAI Grok 2 Vision via OpenRouter — flagship vision capabilities.",
        context_window=131072,
        max_output_tokens=4096,
        input_price_per_1k=0.002,
        output_price_per_1k=0.01,
    ...
    ModelSpec(
        ...
        capability="chat",
        description="OpenAI GPT-5 via OpenRouter — no OpenAI key needed.",
        context_window=400_000,
        max_output_tokens=32_000,
        input_price_per_1k=0.00125,
        output_price_per_1k=0.01,
    ...
    ModelSpec(
        ...
        capability="chat",
        description="Anthropic's best Claude via OpenRouter — best-in-class writing & reasoning.",
        context_window=200_000,
        max_output_tokens=64_000,
        input_price_per_1k=0.015,
        output_price_per_1k=0.075,
        ...
        supports_streaming=True,
        supports_vision=True,
        tags=("anthropic", "premium", "flagship"),
    ),
    ModelSpec(
    ...
    ModelSpec(
        ...
        capability="chat",
        description="Google Gemini 2.5 Pro via OpenRouter — 2M context, reasoning.",
        context_window=2_000_000,
        max_output_tokens=64_000,
        input_price_per_1k=0.00125,
        output_price_per_1k=0.01,
    ...
    ModelSpec(
        ...
        capability="chat",
        description="Mistral Large via OpenRouter — flagship European model.",
        context_window=128_000,
        max_output_tokens=32_000,
        input_price_per_1k=0.003,
    ...
    ModelSpec(
        ...
        capability="chat",
        description="Alibaba's top open model — strong across the board.",
        context_window=128_000,
        input_price_per_1k=0.00045,
        output_price_per_1k=0.00065,
        tier="free",
        supports_streaming=True,
        tags=("alibaba", "open", "latest"),
    ),
    ModelSpec(
